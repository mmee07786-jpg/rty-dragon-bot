...
class RaidEndModal(discord.ui.Modal, title="🏁 | Conclude Raid & Record Results"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        view = RaidSelectView(self.duration.value, self.result_status.value, self.win_reason.value, self.raid_number.value, non_bots, interaction.user)
...
class RaidSelectView(discord.ui.View):
    def __init__(self, duration, result_status, win_reason, raid_number, members, author):
